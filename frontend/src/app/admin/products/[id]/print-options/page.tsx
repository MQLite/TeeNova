...
export default async function AdminProductPrintOptionsPage({ params }: PageProps) {
  ...
  try {
    ...
    if (err instanceof ApiError && err.status === 401) {
      redirectToExpiredLogin(`/admin/products/${id}/print-options`)
    }
    notFound()
  }
  ...
  return (
    <div className="admin-page admin-stack">
      <div className="mb-4">
        <Link
          href={`/admin/products/${product.id}/print-config`}
